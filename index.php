...
$counterFile = __DIR__ . '/view_counter.txt';
if (!file_exists($counterFile)) {
    file_put_contents($counterFile, '0');
}
$pageViews = (int)file_get_contents($counterFile);
$pageViews++;
file_put_contents($counterFile, (string)$pageViews);
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body class="bg-[#FFF9F3] text-gray-800">
    <!-- Remove the entire <nav> for the mobile bottom navigation bar and the <div class="pb-14 sm:pb-0"></div> that follows it. -->
    <div class="container mx-auto flex flex-col items-center justify-start min-h-screen w-full pt-10 pb-10 px-4 sm:px-4">

        <!-- Logo -->
        <div class="flex items-center justify-center mb-2">
            <img src="uploads/logo.png" alt="JewelEntry Logo" class="w-20 h-20 object-contain">
        </div>

        <!-- App Name -->
        <h1 class="text-3xl sm:text-xl font-bold text-gray-800 mb-1">JewelEntry</h1>
        <!-- Subtitle -->
        ...
        <div id="featuresCarousel" class="carousel-container w-full max-w-xs sm:max-w-sm mb-2 relative overflow-hidden cursor-grab">
            <div id="slidesWrapper" class="flex transition-transform duration-300 ease-in-out">
                <!-- Slide 1: Smart Inventory Management -->
                ...
                <!-- Slide 2: Multi-Branch Management -->
                <div class="carousel-slide w-full flex-shrink-0 px-px">
                    <div class="bg-white rounded-xl shadow-md p-4 flex items-center justify-between h-full">
                        <div class="flex items-center">
                ...
                <!-- Slide 3: Analytics & GST Reports -->
                <div class="carousel-slide w-full flex-shrink-0 px-px">
                    <div class="bg-white rounded-xl shadow-md p-4 flex items-center justify-between h-full">
                        <div class="flex items-center">
                            <i class="fas fa-chart-line text-gray-600 text-4xl mr-3 sm:mr-4"></i>
                            <div>
                                <p class="text-md sm:text-lg font-semibold text-gray-800">Analytics & GST Reports</p>
                                <p class="text-xs sm:text-sm text-gray-500">Business insights & tax-ready reports</p>
                            </div>
                        </div>
                        <i class="fas fa-chevron-right text-gray-400 text-xl"></i>
                    </div>
                </div>
                <!-- Slide 4: Digital Certificates -->
                <div class="carousel-slide w-full flex-shrink-0 px-px"> 
                    <div class="bg-white rounded-xl shadow-md p-4 flex items-center justify-between h-full">
                        <div class="flex items-center">
                ...
                <div class="carousel-slide w-full flex-shrink-0 px-px">
                    <div class="bg-white rounded-xl shadow-md p-4 flex items-center justify-between h-full">
                        <div class="flex items-center">
                            ...
                            <div>
                                <p class="text-md sm:text-lg font-semibold text-gray-800">Customer Management</p>
                                <p class="text-xs sm:text-sm text-gray-500">CRM, loyalty & history</p>
                            </div>
                        </div>
                        <i class="fas fa-chevron-right text-gray-400 text-xl"></i>
                    </div>
                </div>
                <!-- Slide 6: Financial Suite -->
                <div class="carousel-slide w-full flex-shrink-0 px-px">
                    <div class="bg-white rounded-xl shadow-md p-4 flex items-center justify-between h-full">
                        <div class="flex items-center">
        ...
        <!-- Carousel Dots -->
        <div id="carouselDots" class="flex justify-center space-x-2 my-4">
        ...
        <div class="flex justify-center gap-4 sm:gap-4 w-full max-w-sm mb-2 overflow-x-auto p-2 hide-scrollbar">
            <!-- Free Trial Metric -->
            <div class="flex items-center justify-center flex-shrink-0 w-[90px] h-[75px]">
                <i class="fas fa-gift text-orange-500 text-base"></i>
                <div class="ml-2 text-center">
                    <p class="font-bold text-gray-800 text-sm" id="freeTrial">7 Days</p>
                    <p class="text-orange-500 text-xs leading-tight font-semibold">Free Trial</p>
                </div>
            </div>
            <!-- Product Metric -->
            <div class="flex items-center justify-center flex-shrink-0 w-[90px] h-[75px]">
        ...
        <p class="text-xs text-gray-400 mb-4 text-center">
            Page views: <span class="font-semibold text-orange-500"><?php echo number_format($pageViews); ?></span>
        </p>
