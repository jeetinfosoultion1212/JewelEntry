...
<head>
    ...
    <title>Repairs - Jewelry Store</title>
...
<body class="font-poppins bg-gray-100">
        ...
        <div class="px-3 py-2">
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-2">
                    ...
                    <div>
                        <h1 class="text-sm font-bold text-gray-800">Repairs</h1>
                        <p class="text-xs text-gray-600 font-medium">Manage jewelry repairs</p>
                    </div>
                </div>
                <div class="flex items-center space-x-2">
    ...
    <div class="px-3 pb-72">
        <div class="py-4">
            <h2 class="text-lg font-bold text-gray-800 mb-4">Repair Orders</h2>
            <!-- Add your repairs content here -->
        </div>
    </div>
