...
// Form submission is now handled by API/add_stock_entry.php
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body class="relative">
        ...
        <form id="inventoryMetalsForm" autocomplete="off" class="bg-white rounded-xl shadow-lg border border-gray-100 p-5">
            ...
            <div class="mb-4">
                ...
                <div id="supplierDiv" style="display:none;">
                  <label class="text-xs text-gray-500 font-semibold">Supplier</label>
                  <div style="position:relative;">
                    <span style="position:absolute; left:10px; top:50%; transform:translateY(-50%); color:#6366f1; font-size:1.1em;"><i class="fa fa-search"></i></span>
                    <input type="text" id="supplierInput" class="border border-gray-200 rounded px-2 py-2 text-xs focus:border-green-400 w-full pl-8 bg-gray-50 focus:bg-white focus:shadow-md transition-all duration-150" placeholder="Type supplier name..." autocomplete="off" style="box-sizing:border-box;">
                    <input type="hidden" name="supplier_id" id="supplierIdHidden">
                    <button type="button" id="addSupplierBtn" style="position:absolute; right:8px; top:50%; transform:translateY(-50%); background:#22c55e; border:none; cursor:pointer; border-radius:50%; width:28px; height:28px; display:flex; align-items:center; justify-content:center; box-shadow:0 2px 6px #22c55e22; transition:background 0.2s;" onmouseover="this.style.background='#16a34a'" onmouseout="this.style.background='#22c55e'">
                      <i class="fa fa-plus text-white" style="font-size:1em;"></i>
                    </button>
            ...
            <div class="section-card bg-gradient-to-r from-amber-100 to-yellow-100 border-2 border-amber-300 p-4 mb-4">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-3 mb-3">
                    <div class="input-with-icon">
                        ...
                        <select name="material_type" required class="compact-input w-full" id="materialTypeSelect">
                    ...
                    <div class="input-with-icon">
                        ...
                        <input type="text" name="hsn_code" id="hsnCode" required class="compact-input w-full" placeholder="HSN Code">
                    </div>
                    <div class="input-with-icon">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-3 mb-3">
                    ...
                    <div class="input-with-icon">
                        ...
                        <input type="number" name="quantity" id="quantity" min="1" step="1" placeholder="Quantity (pcs)" required class="compact-input w-full">
                    </div>
                </div>
    ...
    <div id="addSupplierModal" style="display:none; position:fixed; z-index:1000; left:0; top:0; width:100vw; height:100vh; background:rgba(0,0,0,0.3); align-items:center; justify-content:center;">
      <div style="background:#fff; border-radius:16px; max-width:400px; width:95%; margin:auto; padding:28px 22px 18px 22px; position:relative; box-shadow:0 4px 24px 0 rgba(80,112,255,0.08); border:1.5px solid #e0e7ff;">
        <h2 class="font-bold text-lg mb-4 text-indigo-700 flex items-center gap-2"><i class="fas fa-truck"></i> Add New Supplier</h2>
        <form id="addSupplierForm" class="flex flex-col gap-3">
          <div class="input-with-icon">
            <i class="fas fa-user"></i>
            <input type="text" name="name" placeholder="Name *" required class="compact-input w-full">
          </div>
          <div class="input-with-icon">
            <i class="fas fa-address-card"></i>
            <input type="text" name="contact_info" placeholder="Contact Info" class="compact-input w-full">
          </div>
          <div class="input-with-icon">
            <i class="fas fa-envelope"></i>
            <input type="email" name="email" placeholder="Email" class="compact-input w-full">
          </div>
          <div class="input-with-icon">
            <i class="fas fa-map-marker-alt"></i>
            <input type="text" name="address" placeholder="Address" class="compact-input w-full">
          </div>
          <div class="input-with-icon">
            <i class="fas fa-flag"></i>
            <input type="text" name="state" placeholder="State" class="compact-input w-full">
          </div>
          <div class="input-with-icon">
            <i class="fas fa-phone"></i>
            <input type="text" name="phone" placeholder="Phone" class="compact-input w-full">
          </div>
          <div class="input-with-icon">
            <i class="fas fa-receipt"></i>
            <input type="text" name="gst" placeholder="GST" class="compact-input w-full">
          </div>
          <div class="input-with-icon">
            <i class="fas fa-file-invoice-dollar"></i>
            <input type="text" name="payment_terms" placeholder="Payment Terms" class="compact-input w-full">
          </div>
          <div class="input-with-icon">
            <i class="fas fa-sticky-note"></i>
            <input type="text" name="notes" placeholder="Notes" class="compact-input w-full">
          </div>
          <div class="flex gap-2 mt-2">
            <button type="submit" class="px-6 py-2 rounded-full font-bold text-white bg-green-600 hover:bg-green-700 shadow">Add</button>
            <button type="button" id="closeAddSupplierModal" class="px-6 py-2 rounded-full font-bold text-gray-700 bg-gray-200 hover:bg-gray-300">Cancel</button>
          </div>
    ...
    // Sidebar and header JS from add-stock.php (sidebar toggling, profile menu, etc.)
        ...
        // Show all suppliers on spacebar if input is empty
        ...
        closeAddSupplierModal.addEventListener('click', function() {
        ...
        if (materialTypeSelect && hsnCodeInput) {
            ...
            // Set HSN code on page load if material is pre-selected
            const selected = materialTypeSelect.value;
            hsnCodeInput.value = hsnMap[selected] || '';
        }
    });
